...
const WebsiteDev = () => {
  ...
  const {
    isLoading: webTamplateLoading,
    error: webTamplateErr,
    data: allWebTamplate,
  } = useQuery({
  ...
  return (
    <div className="website-dev">
      ...
      <Stack className="middle2">
        <Typography
          sx={{ fontSize: { xs: "2.5rem", md: "3.2rem" }, textAlign: "center" }}
          mb={2}
          mt={{ xs: 10, lg: 0 }}
          variant="h3"
        >
          We Are Creative Web Development Company
        </Typography>
        <Typography
          sx={{
      ...
      <Stack className="website-demo">
        ...
        >
          {webTamplateLoading ? (
            ...
            allWebTamplate.map((d, i) => <ServiceDemoCard key={i} data={d} />)
          )}
        </Stack>
      </Stack>
      ...
      <Stack className="middle2">
        ...
        >
          {webPackageLoading ? (
            ...
            allWebpackage.map((data, i) => <PackageCard key={i} data={data} />)
          )}
        </Stack>
      </Stack>
      ...
      >
        ...
        <Stack gap={3}>
          ...
          >
            Our website development services are designed to create outstanding
            online experiences. We specialize in crafting websites that not only
            look great but also perform exceptionally well, meeting the unique
            needs of our clients.
          </Typography>
          <Typography variant="h5" color="red">
            Helping clients solve application development problems
          </Typography>
          <Typography
            variant="body"
            sx={{ color: "rgb(199, 199, 199)", fontWeight: "300" }}
          >
            We take pride in solving complex application development challenges.
            Our team is dedicated to delivering solutions that drive growth and
      ...
      <div className="bottom">
        <div className="left">
          ...
          <span className="span">
            Get the best web development from Posh Coder Agency
          </span>
          <Stack direction="row" alignItems="center" gap={2}>
