...
const Graphic = () => {
  const {
    isLoading: graphicPackageLoading,
    error: graphicpackageErr,
    data: allGraphicpackage,
  } = useQuery({
    queryKey: ["graphicpackage"],
    queryFn: () =>
      axiosReq.get("/graphicpackage/getall").then((res) => res.data),
  });
  const {
    isLoading: graphicTemplateLoading,
    error: graphicTemplateErr,
    data: allGraphicTemplate,
  } = useQuery({
    queryKey: ["graphictemplate"],
    queryFn: () =>
      axiosReq.get("/graphictemplate/getall").then((res) => res.data),
  });
    ...
    <div className="graphic">
      ...
      <Container maxWidth="xl">
        <Stack mb="10rem">
          ...
          <Typography
            ...
            variant="h4"
          >
            Get Stunning Design By Paying Small Budget!
          </Typography>
          <Stack
            direction={"row"}
            flexWrap={"wrap"}
      ...
      >
        ...
        <Stack gap={3} mt={{ xs: 10, lg: 0 }}>
          ...
          >
            Our graphic design services are tailored to bring your creative
            ideas to life. We specialize in creating visually stunning designs
            that captivate and engage your audience.
          </Typography>
          <Typography variant="h5" color="red">
            Transforming your ideas into beautiful visuals
          </Typography>
          <Typography
            variant="body"
            sx={{ color: "rgb(199, 199, 199)", fontWeight: "300" }}
          >
            We take pride in turning your concepts into eye-catching graphics
            that leave a lasting impression. Our designs are crafted with
      ...
      <div className="bottom">
        <div className="left">
          ...
          <span className="span">
            Experience the best in Graphic Design from Posh Coder Agency
          </span>
          <Stack direction="row" alignItems="center" gap={2}>
