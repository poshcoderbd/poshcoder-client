    ...
    <div className="marketing">
      ...
      >
        ...
        <Stack gap={3}>
          ...
          >
            Our online business solutions are designed to help you establish and
            grow your business on the internet. We specialize in creating and
            implementing effective strategies that drive online success.
          </Typography>
          ...
          <Typography
            ...
            sx={{ color: "rgb(199, 199, 199)", fontWeight: "300" }}
          >
            We leverage the latest techniques to help you achieve your business
            goals. Our team is dedicated to delivering results and maximizing
            your online impact.
          </Typography>
      ...
      <div className="bottom">
        <div className="left">
          ...
          <span className="span">
            Experience the best in Online Business Solutions from Posh Coder
            Agency
          </span>
          <Stack direction="row" alignItems="center" gap={2}>
