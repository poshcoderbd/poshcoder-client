    ...
    <div className="digital-marketing">
      ...
      >
        ...
        <Stack gap={3} mt={{ xs: 10, lg: 0 }}>
          ...
          >
            ...
            presence and drive business growth. We specialize in creating and
            implementing effective marketing strategies that reach your target
            audience.
          </Typography>
          <Typography variant="h5" color="red">
            Maximizing your online reach and impact
          </Typography>
          <Typography
            variant="body"
            sx={{ color: "rgb(199, 199, 199)", fontWeight: "300" }}
          >
            We use the latest digital marketing techniques to help you achieve
            your business goals. Our team is dedicated to delivering results and
          ...
          <Stack sx={{ color: "#fff" }}>
            ...
            <Stack
              direction="column"
              gap={2}
              sx={{ lineHeight: 1.7, color: "#C0C7C7" }}
            >
              ...
              <Typography variant="body1">
                - **Social Media Management**: Engage with your audience across
                all platforms with curated content.
              </Typography>
              <Typography variant="body1">
                - **Pay-Per-Click Advertising (PPC)**: Drive targeted traffic to
                your website with high-conversion ads.
              </Typography>
              <Typography variant="body1">
                - **Email Marketing**: Craft personalized email campaigns that
                nurture leads and boost sales.
              </Typography>
              <Typography variant="body1">
                - **Content Marketing**: Build authority in your industry with
      ...
      <div className="bottom">
        <div className="left">
          ...
          <span className="span">
            Experience the best in Digital Marketing from Posh Coder Agency
          </span>
          <Stack direction="row" alignItems="center" gap={2}>
